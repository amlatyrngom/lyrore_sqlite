/*
** Counter Plugin V2 - For hot-reload testing
** Returns version 2 from get_version() function
...
class CounterPluginV2 : public Plugin {
public:
...
LYRORE_REGISTER_PLUGIN(CounterPluginV2);
