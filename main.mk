...
preupdate_router.o:	$(TOP)/ext/lyrore_sdk/src/preupdate_router.cpp $(DEPS_OBJ_COMMON)
	$(CXX) $(CFLAGS) $(OPTS) -std=c++17 -fPIC -I$(TOP)/ext/lyrore_sdk/include -I$(TOP)/src -I. -c $(TOP)/ext/lyrore_sdk/src/preupdate_router.cpp
...
#
# Note: Links against libsqlite3.so for Lyrore C++ SDK support
sqlite3$(T.exe):	shell.c libsqlite3.so
	$(CC) $(CFLAGS) -c -o shell.o shell.c $(SHELL_OPT) $(CFLAGS.icu)
	$(CXX) $(CFLAGS) -o $@ shell.o -L. -lsqlite3 \
		$(sqlite3-shell-static.flags.$(STATIC_CLI_SHELL)) \
		$(CFLAGS.readline) $(CFLAGS.icu) \
		$(LDFLAGS.readline) -Wl,-rpath,$(shell pwd)
#
sqlite3$(T.exe)-1:
